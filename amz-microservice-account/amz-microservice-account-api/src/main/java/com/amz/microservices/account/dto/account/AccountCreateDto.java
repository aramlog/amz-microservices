...
@ApiModel(value = "AccountCreateDto")
public class AccountCreateDto {

  @NotNull
  @ApiModelProperty(value = "Account type", example = "CUSTOMER",
      allowableValues = "CUSTOMER, ADMIN, SELLER", required = true)
  ...
  @Size(min = 8, max = 128, message = "Must be at least 8 and 128 max")
  @Pattern(regexp = com.amz.microservices.common.object.Pattern.PASSWORD_PATTERN,
      message = "Must contain at least one upper letter and one digit")
  @ApiModelProperty(value = "Account password", example = "Anna!123", required = true)
